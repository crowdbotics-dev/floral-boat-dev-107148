"""
Django settings for floral_boat_dev_107148 project.
...
ROOT_URLCONF = 'floral_boat_dev_107148.urls'
...
WSGI_APPLICATION = 'floral_boat_dev_107148.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "floral_boat_dev_107148 API",
    "DESCRIPTION": "API documentation for floral_boat_dev_107148 App",
    "VERSION": "v1",
}
